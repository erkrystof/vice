...
# wget -O - https://raw.githubusercontent.com/erkrystof/vice/master/install-vice-3.5-raspi-4-buster-2023-02-21.sh | bash
# or download manually and execute:
# wget https://raw.githubusercontent.com/erkrystof/vice/master/install-vice-3.5-raspi-4-buster-2023-02-21.sh
# chmod +x install-vice-3.5-raspi-4-buster-2023-02-21.sh
# ./install-vice-3.5-raspi-4-buster-2023-02-21.sh
